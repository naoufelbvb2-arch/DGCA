...
Legacy Agent implementation preserved for RFC-09 backwards compatibility (R3 §28).
"""
...
class LegacyCognitiveAgent:
    """الوكيل الإدراكي التفاعلي الشامل القديم لمعمارية DGCA (RFC-09)."""
    ...
    def step_time(self, ticks: int = 1) -> dict[str, int]:
        """تمرير تكات زمنية تشغيلية صامتة."""
...
# Noncanonical alias for legacy tests
CognitiveAgent = LegacyCognitiveAgent
